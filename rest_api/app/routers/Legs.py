...
def insert_leg(leg: Leg, request: Request):
    try:
        ...
        request.app.state.gate_orders[leg.device_id] = leg.order_id
        request.app.state.gate_keys[leg.device_id] = base64.b64encode(get_random_bytes(32)).decode('utf-8')
        #request.app.state.encrypted_symmetric_keys[leg.device_id] = request.app.state.gate_keys[leg.device_id]
